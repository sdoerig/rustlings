...
mod tests {
    ...
    fn test_iterate_string_vec() {
        ...
        let capitalized_words: Vec<String> = words.into_iter().map(|val| capitalize_first(&val)).collect();
    ...
    fn test_iterate_into_string() {
        let words = vec!["hello", " ", "world"];
        let capitalized_words = words.into_iter().map(|val| capitalize_first(&val)).collect::<String>();// TODO
        assert_eq!(capitalized_words, "Hello World");
    }
}
